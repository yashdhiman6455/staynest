...
async function submit() {
    ...
    try {
        ...
        serverError.value = extractErrorMessage(error, 'Unable to create your account. Please try again.');
    }
}
</script>
            ...
            <div class="w-full max-w-md animate-fade-up">
                <div class="card p-8 sm:p-10">
                    <div class="flex flex-col items-center text-center">
                        <BrandLogo :size="52" />
                        <h1 class="mt-5 text-2xl font-extrabold tracking-tight text-night-900">Create your account</h1>
                        <p class="mt-1 text-sm text-night-500">Join StayNest and start listing your spaces.</p>
                    </div>
                    ...
                    <form class="mt-8 space-y-5" @submit.prevent="submit">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                class="input"
                                :class="fieldErrors.name ? 'border-red-400 focus:ring-red-500/30' : ''"
                            />
                            <p v-if="fieldErrors.name" class="mt-1.5 text-xs font-medium text-red-600">{{ fieldErrors.name }}</p>
                        </div>
                    ...
                    <p class="mt-6 text-center text-sm text-night-500">
                        ...
                        <RouterLink :to="{ name: 'login' }" class="font-bold text-brand-600 hover:text-brand-700">
                            Log in
                        </RouterLink>
                    </p>
                </div>
